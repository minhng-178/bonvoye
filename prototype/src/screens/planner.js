...
(function (root) {
  ...
  function renderSelect() {
    ...
    return page(copy().select, copy().subtitle, body);
  }
  function renderDuration() {
    ...
    return page(copy().duration, "Hành trình sẽ tự điều chỉnh theo thời gian bạn chọn.", body);
  }
  ...
  function renderGenerated() {
    var body = '<div class="bv-route-map"><span class="bv-route-stop one">1</span><span class="bv-route-stop two">2</span><span class="bv-route-stop three">3</span></div>' +
    ...
    return page(copy().generated, "90 phút · Đi bộ thong thả", body);
  }
  function renderEdit() {
    ...
    return page(copy().edit, "Thay đổi chỉ áp dụng cho hành trình này.", body);
  }
  function renderSaved() {
    ...
    return page(copy().saved, "Bạn có thể tải từng POI trước khi ra đường.", body);
  }
