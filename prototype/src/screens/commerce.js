...
(function (root) {
  ...
  function renderOffers() {
    ...
    return page(copy().title, copy().subtitle, body);
  }
  function renderProcessing() {
    ...
    return page(copy().processing, "Không rời ứng dụng trong khi giao dịch đang được xác nhận.", body);
  }
  function renderSuccess() {
    ...
    return page(copy().success, "Bạn có thể bắt đầu nghe ngay khi tới địa điểm.", body);
  }
  function renderFailure() {
    ...
    return page(copy().failure, "Bạn có thể thử lại mà không mất lựa chọn hiện tại.", body);
  }
  function renderRestore(variant) {
    ...
    return page(restored ? copy().restored : copy().restore, restored ? "Hoàn tất đồng bộ quyền truy cập." : "Khôi phục giao dịch không mua lại nội dung.", body);
  }
  function renderRestoreEmpty() {
    ...
    return page(copy().restore, "Không có quyền truy cập nào được tìm thấy trên thiết bị này.", body);
  }
